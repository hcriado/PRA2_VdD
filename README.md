...
En la carpeta Datasets se encuentran los archivos .csv que se han empleado para la realización de las visualizaciones, siendo el más importante el archivo "dubizzle_cars_dataset_MODIFIED.csv". Este se trata de un archivo similar al original pero sobre el cual se han tratado los datos de algunas columnas de interés para suplir la falta de elementos.
